...
def preprocess(sentence):
    ...
    # return a list of the lowrcased words from the tokenized sentence. 
    return [entry.lower() for entry in words if alphabetic.match(entry)] 
...
def np_chunk(tree):
    ...
    """
    # a list that will contain all of the noun phrase chunks
    chunks=[]
